...
enum
{
  ...
  PROP_VISIBLE_NAME,
  PROP_WORD_CHARS,
  PROP_HIGHLIGHT_TAB_ON_BELL,
  PROP_HIGHLIGHT_FOCUSED_TAB_ON_BELL,
  PROP_URGENT_WINDOW_ON_BELL,
  PROP_URGENT_FOCUSED_WINDOW_ON_BELL,
  LAST_PROP
};
...
#define KEY_HIGHLIGHT_TAB_ON_BELL "highlight_tab_on_bell"
#define KEY_HIGHLIGHT_FOCUSED_TAB_ON_BELL "highlight_focused_tab_on_bell"
...
#define KEY_URGENT_WINDOW_ON_BELL "urgent_window_on_bell"
#define KEY_URGENT_FOCUSED_WINDOW_ON_BELL "urgent_focused_window_on_bell"
...
#define DEFAULT_HIGHLIGHT_TAB_ON_BELL (FALSE)
#define DEFAULT_HIGHLIGHT_FOCUSED_TAB_ON_BELL (FALSE)
...
#define DEFAULT_URGENT_WINDOW_ON_BELL (FALSE)
#define DEFAULT_URGENT_FOCUSED_WINDOW_ON_BELL (FALSE)
...
#define TERMINAL_PROFILE_PROPERTY_VALUE_ARRAY_BOXED(prop, propElementName, propElementType, propGConf)\
  ...
  TERMINAL_PROFILE_PROPERTY_BOOLEAN (HIGHLIGHT_TAB_ON_BELL, DEFAULT_HIGHLIGHT_TAB_ON_BELL, KEY_HIGHLIGHT_TAB_ON_BELL);
  TERMINAL_PROFILE_PROPERTY_BOOLEAN (HIGHLIGHT_FOCUSED_TAB_ON_BELL, DEFAULT_HIGHLIGHT_FOCUSED_TAB_ON_BELL, KEY_HIGHLIGHT_FOCUSED_TAB_ON_BELL);
  TERMINAL_PROFILE_PROPERTY_BOOLEAN (URGENT_WINDOW_ON_BELL, DEFAULT_URGENT_WINDOW_ON_BELL, KEY_URGENT_WINDOW_ON_BELL);
  TERMINAL_PROFILE_PROPERTY_BOOLEAN (URGENT_FOCUSED_WINDOW_ON_BELL, DEFAULT_URGENT_FOCUSED_WINDOW_ON_BELL, KEY_URGENT_FOCUSED_WINDOW_ON_BELL);
